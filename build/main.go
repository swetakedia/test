...
// structures used by the test network, most importanly transactions.
//
...
var (
	...
	// to the main public test network.
...
// Network establishes the test network that a transaction should apply to.
