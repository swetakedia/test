...
func TestBuild(t *testing.T) {
	...
	RunSpecs(t, "Package: github.com/test/go/build")
}

// ExampleTransactionBuilder creates and signs a simple transaction, and then
// encodes it into a base64 string capable of being submitted to test-core.
//
...
// encodes the transaction into a base64 string capable of being submitted to test-core. It uses
...
// being submitted to test-core. It uses the transaction builder system.
func ExamplePayment() {
	seed := "SDOTALIMPAM2IV65IOZA7KZL7XWZI5BODFXTRVLIHLQZQCKK57PH5F3H"
	tx, err := Transaction(
		SourceAccount{seed},
