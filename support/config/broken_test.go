...
func TestOptionalTestFields(t *testing.T) {
	var val struct {
		F1 string `valid:"test_accountid,optional"`
		F2 string `valid:"optional,test_accountid"`
		F3 string `valid:"test_seed,optional"`
		F4 string `valid:"optional,test_accountid"`
	}
