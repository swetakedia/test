...
func TestAccountIDValidator(t *testing.T) {
	var val struct {
		Empty        string `valid:"test_accountid"`
		NotSTRKey    string `valid:"test_accountid"`
		NotAccountID string `valid:"test_accountid"`
		Valid        string `valid:"test_accountid"`
		WrongType    int    `valid:"test_accountid"`
	}
...
func TestSeedValidator(t *testing.T) {
	var val struct {
		Empty     string `valid:"test_seed"`
		NotSTRKey string `valid:"test_seed"`
		NotSeed   string `valid:"test_seed"`
		Valid     string `valid:"test_seed"`
		WrongType int    `valid:"test_seed"`
	}
