// Package resource contains the type definitions for all of testhorizons
// response resources.
package testhorizon
...
type Root struct {
	...
	TestHorizonVersion               string `json:"testhorizon_version"`
	TestCoreVersion           string `json:"core_version"`
	TestHorizonSequence              int32  `json:"history_latest_ledger"`
...
// Trade represents a testhorizon digested trade
type Trade struct {
	Links struct {
		Self      hal.Link `json:"self"`
...
// testhorizon-specific type name.
