...
type AuthData struct {
	// The test address of the customer that is initiating the send.
	Sender string `json:"sender" valid:"required,test_address"`
...
type AuthResponse struct {
	...
	// (only present if info_status is ok) JSON of the recipient's AML information. in the Test attachment convention
...
// Transaction represents transaction field in Test attachment
...
// Operation represents a single operation object in Test attachment
