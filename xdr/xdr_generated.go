...
// TestValueExt is an XDR NestedUnion defines as:
//
//   union switch (int v)
//        {
//        case 0:
...
//        }
//
type TestValueExt struct {
	V int32
}

// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u TestValueExt) SwitchFieldName() string {
	return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of TestValueExt
func (u TestValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch int32(sw) {
	case 0:
		return "", true
	}
...
// NewTestValueExt creates a new  TestValueExt.
func NewTestValueExt(v int32, value interface{}) (result TestValueExt, err error) {
	result.V = v
	switch int32(v) {
	case 0:
		// void
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s TestValueExt) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *TestValueExt) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*TestValueExt)(nil)
	_ encoding.BinaryUnmarshaler = (*TestValueExt)(nil)
)

// TestValue is an XDR Struct defines as:
//
//   struct TestValue
//    {
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s TestValue) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *TestValue) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*TestValue)(nil)
	_ encoding.BinaryUnmarshaler = (*TestValue)(nil)
)
...
//        TestValue scpValue;   // what consensus agreed to
...
// TestMessage is an XDR Union defines as:
//
//   union TestMessage switch (MessageType type)
//    {
//    case ERROR_MSG:
//        Error error;
//    case HELLO:
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u TestMessage) SwitchFieldName() string {
	return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of TestMessage
func (u TestMessage) ArmForSwitch(sw int32) (string, bool) {
...
func NewTestMessage(aType MessageType, value interface{}) (result TestMessage, err error) {
	result.Type = aType
...
// panicing if the value is not set.
func (u TestMessage) MustError() Error {
	val, ok := u.GetError()
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetError() (result Error, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustHello() Hello {
	val, ok := u.GetHello()
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetHello() (result Hello, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustAuth() Auth {
	val, ok := u.GetAuth()
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetAuth() (result Auth, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustDontHave() DontHave {
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetDontHave() (result DontHave, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustPeers() []PeerAddress {
	val, ok := u.GetPeers()
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetPeers() (result []PeerAddress, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustTxSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetTxSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustTxSet() TransactionSet {
	val, ok := u.GetTxSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetTxSet() (result TransactionSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustTransaction() TransactionEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetTransaction() (result TransactionEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustQSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetQSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustQSet() ScpQuorumSet {
	val, ok := u.GetQSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetQSet() (result ScpQuorumSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustEnvelope() ScpEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetEnvelope() (result ScpEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u TestMessage) MustGetScpLedgerSeq() Uint32 {
...
// returning ok if the union's switch indicated the value is valid.
func (u TestMessage) GetGetScpLedgerSeq() (result Uint32, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s TestMessage) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *TestMessage) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*TestMessage)(nil)
	_ encoding.BinaryUnmarshaler = (*TestMessage)(nil)
)
