// Package network contains functions that deal with test network passphrases
// and IDs.
package network
...
import (
	...
	"github.com/test/go/hash"
	"github.com/test/go/support/errors"
	"github.com/test/go/xdr"
)

const (
	// PublicNetworkPassphrase is the pass phrase used for every transaction intended for the public test network
	PublicNetworkPassphrase = "Public Global Test Network ; September 2015"
...
// resulting hash is the value that can be signed by test secret key to
// authorize the transaction identified by the hash to test validators.
