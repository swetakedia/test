// Package address provides utility functions for working with test
// addresses. See https://www.test.org/developers/guides/concepts/federation.
// html#test-addresses for more on addresses.
package address
