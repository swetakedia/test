// Copyright 2016 Test Development Foundation and contributors. Licensed
...
import (
	...
	"github.com/test/go/tools/test-archivist/internal"
)
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "test-archivist",
		Short: "inspect test history archive",
