...
import (
	...
	"github.com/test/go/exp/crypto/derivation"
...
var AccountsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		masterKey, err := derivation.DeriveForPath(derivation.TestAccountPrefix, seed)
		if err != nil {
		...
		for i := uint32(startID); i < startID+count; i++ {
			...
			println(fmt.Sprintf(derivation.TestAccountPathFormat, i), kp.Address(), kp.Seed())
		}
