...
func (handler *FriendbotHandler) doHandle(r *http.Request) (*testhorizon.TransactionSuccess, error) {
...
func (handler *FriendbotHandler) loadResult(address string) (*testhorizon.TransactionSuccess, error) {
