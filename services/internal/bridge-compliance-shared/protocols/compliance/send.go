...
type SendRequest struct {
	...
	// Source account ID
	Source string `form:"source" valid:"required,test_accountid"`
	// Sender address (like alice*test.org)
	Sender string `form:"sender" valid:"required,test_address"`
	// Destination address (like bob*test.org)
	Destination string `form:"destination" valid:"required,test_address"`
	// ForwardDestination
