...
import (
	...
	"github.com/test/go/services/internal/bridge-compliance-shared/http/helpers"
	"github.com/test/go/services/internal/bridge-compliance-shared/protocols"
	complianceServer "github.com/test/go/services/internal/bridge-compliance-shared/protocols/compliance"
...
var (
	...
	PaymentCannotResolveDestination = &helpers.ErrorResponse{Code: "cannot_resolve_destination", Message: "Cannot resolve federated Test address.", Status: http.StatusBadRequest}
...
type PaymentRequest struct {
	...
	Source string `form:"source" valid:"optional,test_seed"`
	// Sender address (like alice*test.org)
	Sender string `form:"sender" valid:"optional,test_address"`
	// Destination address (like bob*test.org)
	Destination string `form:"destination" valid:"optional,test_destination"`
	// ForwardDestination
	...
	Amount string `form:"amount" valid:"required,test_amount"`
	// Code of the asset destination should receive
	AssetCode string `form:"asset_code" valid:"optional,test_asset_code"`
	// Issuer of the asset destination should receive
	AssetIssuer string `form:"asset_issuer" valid:"optional,test_accountid"`
	// Only for path_payment
	SendMax string `form:"send_max" valid:"optional,test_amount"`
	// Only for path_payment
	SendAssetCode string `form:"send_asset_code" valid:"optional,test_asset_code"`
	// Only for path_payment
	SendAssetIssuer string `form:"send_asset_issuer" valid:"optional,test_accountid"`
