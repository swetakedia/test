...
import (
	...
	protocol "github.com/test/go/protocols/testhorizon"
	"github.com/test/go/services/testhorizon/internal/db2/assets"
...
func TestLargeAmount(t *testing.T) {
	row := assets.AssetStatsR{
		...
		NumAccounts: 429,
		Flags:       0,
		Toml:        "https://xim.com/.well-known/test.toml",
	}
	...
	assert.Equal(t, "https://xim.com/.well-known/test.toml", res.Links.Toml.Href)
}
