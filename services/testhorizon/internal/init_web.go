...
// Web contains the http server related fields for testhorizon: the router,
// rate limiter, etc.
type Web struct {
	router      *chi.Mux
...
// initWebMiddleware installs the middleware stack used for testhorizon onto the
// provided app.
...
// initWebActions installs the routing configuration of testhorizon onto the
...
func initWebActions(app *App) {
	...
	// Deprecated - remove in: testhorizon-v0.18.0
