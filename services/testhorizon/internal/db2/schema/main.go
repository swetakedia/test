...
// Migrations represents all of the schema migration for testhorizon
...
// version of TestHorizon. To keep the code simple, it does not provide a list of
// migration names.
func GetNumMigrationsDown(dbUrl string) (nMigrations int) {
	...
	// Get the list of migrations needed by this version of TestHorizon
