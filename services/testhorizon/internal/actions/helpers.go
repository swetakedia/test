...
import (
	...
	"github.com/test/go/support/time"
...
// GetAddress retrieves a test address.  It confirms the value loaded is a
// valid test address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a test
...
// the string at the provided name in accordance with the test client
// conventions
