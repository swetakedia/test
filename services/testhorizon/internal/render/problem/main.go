...
import (
	...
	"github.com/test/go/services/testhorizon/internal/hchi"
...
var (
	...
	ServerOverCapacity = problem.P{
		...
		Detail: "This testhorizon server is currently overloaded.  Please wait for " +
	...
	BeforeHistory = problem.P{
		...
		Detail: "This testhorizon instance is configured to only track a " +
			"portion of the test network's latest history. This request " +
			"is asking for results prior to the recorded history known to " +
			"this testhorizon instance.",
	}
	...
	StaleHistory = problem.P{
		...
		Status: http.StatusServiceUnavailable,
		Detail: "This testhorizon instance is configured to reject client requests " +
			"when it can determine that the history database is lagging too far " +
			"behind the connected instance of test-core.  If you operate this " +
