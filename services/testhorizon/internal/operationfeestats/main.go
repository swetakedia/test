...
// stats within test,specifically as a central location to store a cached snapshot
...
// State represents a snapshot of testhorizon's view of the state of operation fee's
// on the network.
type State struct {
	FeeMin      int64
	FeeMode     int64
