...
// be submitted to the backing test-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to test-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to test-core
