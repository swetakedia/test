// Package txsub provides the machinery that testhorizon uses to submit transactions to
// the test network and track their progress.  It also helps to hide some of the
