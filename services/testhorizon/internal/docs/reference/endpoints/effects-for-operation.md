...
clientData:
  laboratoryUrl: https://www.test.org/laboratory/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://testhorizon-testnet.test.org/operations/77309415424/effects"
```
