...
clientData:
  laboratoryUrl: https://www.test.org/laboratory/#explorer?resource=operations&endpoint=for_account
---
...
```sh
curl "https://testhorizon-testnet.test.org/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/operations"
```
