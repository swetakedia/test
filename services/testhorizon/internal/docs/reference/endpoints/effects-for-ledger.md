...
clientData:
  laboratoryUrl: https://www.test.org/laboratory/#explorer?resource=effects&endpoint=for_ledger
---
...
```sh
curl "https://testhorizon-testnet.test.org/ledgers/69859/effects"
```
