...
clientData:
  laboratoryUrl: https://www.test.org/laboratory/#explorer?resource=payments&endpoint=for_ledger
---
...
```sh
curl "https://testhorizon-testnet.test.org/ledgers/69859/payments"
```
