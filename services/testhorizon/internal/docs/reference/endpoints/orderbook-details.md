...
clientData:
  laboratoryUrl: https://www.test.org/laboratory/#explorer?resource=order_book&endpoint=details
---

People on the Test network can make [offers](../resources/offer.md) to buy or sell assets.  These offers are summarized by the assets being bought and sold in [orderbooks](../resources/orderbook.md).

TestHorizon will return, for each orderbook, a summary of the orderbook and the bids and asks associated with that orderbook.
...
```sh
curl "https://testhorizon-testnet.test.org/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=FOO&buying_asset_issuer=GBAUUA74H4XOQYRSOW2RZUA4QL5PB37U3JS5NE3RTB2ELJVMIF5RLMAG&limit=20"
```
...
server.orderbook(new TestSdk.Asset.native(), new TestSdk.Asset('FOO', 'GBAUUA74H4XOQYRSOW2RZUA4QL5PB37U3JS5NE3RTB2ELJVMIF5RLMAG'))
  .call()
