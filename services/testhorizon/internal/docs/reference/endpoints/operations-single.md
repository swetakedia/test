...
clientData:
  laboratoryUrl: https://www.test.org/laboratory/#explorer?resource=operations&endpoint=single
---
...
```sh
curl https://testhorizon-testnet.test.org/operations/77309415424
```
