...
clientData:
  laboratoryUrl: https://www.test.org/laboratory/#explorer?resource=operations&endpoint=for_ledger
---
...
```sh
curl "https://testhorizon-testnet.test.org/ledgers/69859/operations"
```
