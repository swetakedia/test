...
In order to provide service stability, TestHorizon limits the number of requests a
...
TestHorizon is using [GCRA](https://brandur.org/rate-limiting#gcra) algorithm.

## Response headers for rate limiting

Every response from TestHorizon sets advisory headers to inform clients of their
