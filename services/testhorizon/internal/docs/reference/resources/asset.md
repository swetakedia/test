...
**Assets** are the units that are traded on the Test Network.

An asset consists of an type, code, and issuer.

To learn more about the concept of assets in the Test network, take a look at the [Test assets concept guide](https://www.test.org/developers/guides/concepts/assets.html).
...
|--------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------
| toml  | `https://www.test.org/.well-known/test.toml`| Link to the TOML file for this issuer |
...
```json
{
  "_links": {
    "toml": {
      "href": "https://www.test.org/.well-known/test.toml"
    }
  },
