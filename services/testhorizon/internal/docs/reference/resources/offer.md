...
Accounts on the Test network can make [offers](http://test.org/developers/learn/concepts/exchange.html) to buy or sell assets.  Users can create offers with the [Manage Offer](http://test.org/developers/learn/concepts/list-of-operations.html) operation.

TestHorizon only returns offers that belong to a particular account.  When it does, it uses the following format:
...
| selling     | [Asset](http://test.org/developers/learn/concepts/assets.html)           | The Asset this offer wants to sell.                      |
| buying     | [Asset](http://test.org/developers/learn/concepts/assets.html) | The Asset this offer wants to buy. |
