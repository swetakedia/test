...
| base | [Asset](http://test.org/developers/learn/concepts/assets.html) | The Asset this offer wants to sell.|
| counter | [Asset](http://test.org/developers/learn/concepts/assets.html) | The Asset this offer wants to buy.|
