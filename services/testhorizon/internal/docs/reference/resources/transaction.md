...
**Transactions** are the basic unit of change in the Test Network.

A transaction is a grouping of [operations](./operation.md).

To learn more about the concept of transactions in the Test network, take a look at the [Test transactions concept guide](https://www.test.org/developers/learn/concepts/transactions.html).
...
| ---------------------------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| self | `https://testhorizon-testnet.test.org/transactions/cb9a25394acb6fe0d1d9bdea5afc01cafe2c6fde59a96ddceb2564a65780a81f` |  |
| account | `https://testhorizon-testnet.test.org/accounts/GCDLRUXOD6KA53G5ILL435TZAISNLPS4EKIHSOVY3MVD3DVJ333NO4DT` | The source [account](../accounts-single.md) for this transaction. |
| ledger | `https://testhorizon-testnet.test.org/ledgers/2352988` | The [ledger](../ledgers-single.md) in which this transaction was applied. |
| operations | `https://testhorizon-testnet.test.org/transactions/cb9a25394acb6fe0d1d9bdea5afc01cafe2c6fde59a96ddceb2564a65780a81f/operations{?cursor,limit,order}"` | [Operations](../operations-for-transaction.md) included in this transaction. |
| effects | `https://testhorizon-testnet.test.org/transactions/cb9a25394acb6fe0d1d9bdea5afc01cafe2c6fde59a96ddceb2564a65780a81f/effects{?cursor,limit,order}"` | [Effects](../effects-for-transaction.md) which resulted by operations in this transaction. |
| precedes | `https://testhorizon-testnet.test.org/transactions?order=asc&cursor=10106006507900928` | A collection of transactions that occur after this transaction. |
| succeeds | `https://testhorizon-testnet.test.org/transactions?order=desc&cursor=10106006507900928` | A collection of transactions that occur before this transaction. |
...
```json
{
  "_links": {
    "self": {
      "href": "https://testhorizon-testnet.test.org/transactions/cb9a25394acb6fe0d1d9bdea5afc01cafe2c6fde59a96ddceb2564a65780a81f"
    },
    "account": {
      "href": "https://testhorizon-testnet.test.org/accounts/GCDLRUXOD6KA53G5ILL435TZAISNLPS4EKIHSOVY3MVD3DVJ333NO4DT"
    },
    "ledger": {
      "href": "https://testhorizon-testnet.test.org/ledgers/2352988"
    },
    "operations": {
      "href": "https://testhorizon-testnet.test.org/transactions/cb9a25394acb6fe0d1d9bdea5afc01cafe2c6fde59a96ddceb2564a65780a81f/operations{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://testhorizon-testnet.test.org/transactions/cb9a25394acb6fe0d1d9bdea5afc01cafe2c6fde59a96ddceb2564a65780a81f/effects{?cursor,limit,order}",
      "templated": true
    },
    "precedes": {
      "href": "https://testhorizon-testnet.test.org/transactions?order=asc&cursor=10106006507900928"
    },
    "succeeds": {
      "href": "https://testhorizon-testnet.test.org/transactions?order=desc&cursor=10106006507900928"
    }
  },
...
To submit a new transaction to Test network, it must first be built and signed locally. Then you can submit a hex representation of your transaction’s [XDR](../../learn/xdr.md) to the `/transactions` endpoint. Read more about submitting transactions in [Post Transaction](../transactions-create.md) doc.
