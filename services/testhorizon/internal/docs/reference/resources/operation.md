...
[Operations](https://www.test.org/developers/learn/concepts/operations.html) are objects that represent a desired change to the ledger: payments,
offers to exchange currency, changes made to account options, etc.  Operations
are submitted to the Test network grouped in a [Transaction](./transaction.md).

To learn more about the concept of operations in the Test network, take a look at the [Test operations concept guide](https://www.test.org/developers/learn/concepts/operations.html).

## Operation Types

| type                                          | type_i | description                                                                                                |
|-----------------------------------------------|--------|------------------------------------------------------------------------------------------------------------|
| [CREATE_ACCOUNT](#create-account)             | 0      | Creates a new account in Test network.
| [PAYMENT](#payment)                           | 1      | Sends a simple payment between two accounts in Test network.
| [PATH_PAYMENT](#path-payment)                 | 2      | Sends a path payment between two accounts in the Test network.
| [MANAGE_OFFER](#manage-offer)                 | 3      | Creates, updates or deletes an offer in the Test network.
...
offer to trade assets in the Test network.
