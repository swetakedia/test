...
type Config struct {
	...
	TestHorizon           string    `valid:"optional"`
...
func (c *Config) Validate() (err error) {
	...
	if c.TestHorizon == "" {
		err = errors.New("testhorizon param is required")
		return
	}

	_, err = url.Parse(c.TestHorizon)
	if err != nil {
		err = errors.New("Cannot parse testhorizon param")
		return
	}
