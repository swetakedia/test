...
// validated transactions and sends it to TestAccountConfigurator for account configuration.
func (s *Server) poolTransactionsQueue() {
	...
	for {
		...
		go s.TestAccountConfigurator.ConfigureAccount(
			transaction.TestPublicKey,
