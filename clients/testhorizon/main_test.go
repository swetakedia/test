...
func ExampleClient_SubmitTransaction() {
	...
	if err != nil {
		fmt.Println(err)
		herr, isTestHorizonError := err.(*Error)
		if isTestHorizonError {
			resultCodes, err := herr.ResultCodes()
			if err != nil {
				fmt.Println("failed to extract result codes from testhorizon response")
				return
			}
...
func TestLoadAccount(t *testing.T) {
	...
	if assert.Error(t, err) {
		assert.Contains(t, err.Error(), "TestHorizon error")
		testhorizonError, ok := err.(*Error)
		assert.Equal(t, ok, true)
		assert.Equal(t, testhorizonError.Problem.Title, "Resource Missing")
	}
...
func TestLoadAccountMergeAmount(t *testing.T) {
	...
	// failure response -- decode error on testhorizon error
	hmock.On(
		"GET",
		"https://localhost/operations/43989725060534273/effects",
...
func TestSubmitTransaction(t *testing.T) {
	...
	if assert.Error(t, err) {
		assert.Contains(t, err.Error(), "TestHorizon error")
		testhorizonError, ok := errors.Cause(err).(*Error)
		assert.Equal(t, ok, true)
		assert.Equal(t, testhorizonError.Problem.Title, "Transaction Failed")
	}
...
var accountMergeEffectsResponse = `{
  "_links": {
    "self": {
      "href": "https://testhorizon-testnet.test.org/operations/43989725060534273/effects?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://testhorizon-testnet.test.org/operations/43989725060534273/effects?cursor=43989725060534273-3&limit=10&order=asc"
    },
    "prev": {
      "href": "https://testhorizon-testnet.test.org/operations/43989725060534273/effects?cursor=43989725060534273-1&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "operation": {
            "href": "https://testhorizon-testnet.test.org/operations/43989725060534273"
          },
          "succeeds": {
            "href": "https://testhorizon-testnet.test.org/effects?order=desc&cursor=43989725060534273-1"
          },
          "precedes": {
            "href": "https://testhorizon-testnet.test.org/effects?order=asc&cursor=43989725060534273-1"
          }
        },
      ...
      },
      {
        "_links": {
          ...
          "succeeds": {
            "href": "https://testhorizon-testnet.test.org/effects?order=desc&cursor=43989725060534273-2"
          },
          "precedes": {
            "href": "https://testhorizon-testnet.test.org/effects?order=asc&cursor=43989725060534273-2"
          }
        },
      ...
      },
      {
        "_links": {
          ...
          "succeeds": {
            "href": "https://testhorizon-testnet.test.org/effects?order=desc&cursor=43989725060534273-3"
          },
          "precedes": {
            "href": "https://testhorizon-testnet.test.org/effects?order=asc&cursor=43989725060534273-3"
          }
        },
...
var accountResponse = `{
  "_links": {
    "self": {
      "href": "https://testhorizon-testnet.test.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H"
    },
    "transactions": {
      "href": "https://testhorizon-testnet.test.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/transactions{?cursor,limit,order}",
      "templated": true
    },
    "operations": {
      "href": "https://testhorizon-testnet.test.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/operations{?cursor,limit,order}",
      "templated": true
    },
    "payments": {
      "href": "https://testhorizon-testnet.test.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/payments{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://testhorizon-testnet.test.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/effects{?cursor,limit,order}",
      "templated": true
    },
    "offers": {
      "href": "https://testhorizon-testnet.test.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/Offers{?cursor,limit,order}",
      "templated": true
    }
  },
...
var accountOffersResponse = `{
  "_links": {
    "self": {
      "href": "https://testhorizon.test.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK/offers?order=asc\u0026limit=10\u0026cursor="
    },
    "next": {
      "href": "https://testhorizon.test.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK/offers?order=asc\u0026limit=10\u0026cursor=2539"
    },
    "prev": {
      "href": "https://testhorizon.test.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK/offers?order=desc\u0026limit=10\u0026cursor=161"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://testhorizon.test.org/offers/161"
          },
          "offer_maker": {
            "href": "https://testhorizon.test.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK"
          }
        },
        "id": 161,
        "paging_token": "161",
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://testhorizon.test.org/offers/2539"
          },
          "offer_maker": {
            "href": "https://testhorizon.test.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK"
          }
...
var transactionResponse = `{
  "_links": {
    "self": {
      "href": "https://testhorizon.test.org/transactions/a4ca51d09610154409890763e2c8ecbaa36688c957dea1df0578bdbc1f65d312"
    },
    "account": {
      "href": "https://testhorizon.test.org/accounts/GBQ352ACDO6DEGI42SOI4DCB654N7B7DANO4RSBGA5CZLM4475CQNID4"
    },
    "ledger": {
      "href": "https://testhorizon.test.org/ledgers/17425656"
    },
    "operations": {
      "href": "https://testhorizon.test.org/transactions/a4ca51d09610154409890763e2c8ecbaa36688c957dea1df0578bdbc1f65d312/operations{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://testhorizon.test.org/transactions/a4ca51d09610154409890763e2c8ecbaa36688c957dea1df0578bdbc1f65d312/effects{?cursor,limit,order}",
      "templated": true
    },
    "precedes": {
      "href": "https://testhorizon.test.org/transactions?order=asc&cursor=74842622631374848"
    },
    "succeeds": {
      "href": "https://testhorizon.test.org/transactions?order=desc&cursor=74842622631374848"
    }
  },
...
var notFoundResponse = `{
  "type": "https://test.org/testhorizon-errors/not_found",
  "title": "Resource Missing",
  "status": 404,
  "detail": "The resource at the url requested was not found.  This is usually occurs for one of two reasons:  The url requested is not valid, or no data in our database could be found with the parameters provided.",
  "instance": "testhorizon-live-001/61KdRW8tKi-18408110"
}`

var submitResponse = `{
  "_links": {
    "transaction": {
      "href": "https://testhorizon-testnet.test.org/transactions/ee14b93fcd31d4cfe835b941a0a8744e23a6677097db1fafe0552d8657bed940"
    }
  },
...
var transactionFailure = `{
  "type": "https://test.org/testhorizon-errors/transaction_failed",
  "title": "Transaction Failed",
  "status": 400,
  "detail": "The transaction failed when submitted to the test network. The extras.result_codes field on this response contains further details.  Descriptions of each code can be found at: https://www.test.org/developers/learn/concepts/list-of-operations.html",
  "instance": "testhorizon-testnet-001.prd.test001.internal.test-ops.com/4elYz2fHhC-528285",
  "extras": {
...
var internalServerError = `{
  ...
  "status":   500,
  "details":  "TestHorizon unavailible",
