// Package federation provides a pluggable handler that satisfies the Test
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided test address.
...
// conform to the Test federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// test account id to lookup, such as
