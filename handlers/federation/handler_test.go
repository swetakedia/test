...
func TestHandler(t *testing.T) {
    ...
    INSERT INTO people (id, name, domain) VALUES 
      ('GD2GJPL3UOK5LX7TWXOACK2ZPWPFSLBNKL3GTGH6BLBNISK4BGWMFBBG', 'scott', 'test.org'),
      ('GCYMGWPZ6NC2U7SO6SMXOP5ZLXOEC5SYPKITDMVEONLCHFSCCQR2J4S3', 'bartek', 'test.org');
  `)
	defer db.Close()
	...
	server.GET("/federation").
		...
		Status(http.StatusOK).
		JSON().Object().
		ContainsKey("test_address").
		ValueEqual("test_address", "scott*test.org")
