...
const (
	// TestAccountPrefix is a prefix for Test key pairs derivation.
	TestAccountPrefix = "m/44'/148'"
	// TestPrimaryAccountPath is a derivation path of the primary account.
	TestPrimaryAccountPath = "m/44'/148'/0'"
	// TestAccountPathFormat is a path format used for Test key pair
	// derivation as described in SEP-00XX. Use with `fmt.Sprintf` and `DeriveForPath`.
	TestAccountPathFormat = "m/44'/148'/%d'"
